<script lang="ts">
	const icons: Record<string, string> = {
		'shopping-cart': `<path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/>`,
		...
		'clipboard-list': `<path d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><line x1="8" y1="11" x2="8.01" y2="11"/><line x1="12" y1="11" x2="16" y2="11"/><line x1="8" y1="15" x2="8.01" y2="15"/><line x1="12" y1="15" x2="16" y2="15"/>`,
	...
	let { name, size = 24, strokeWidth = 2, ...rest }: { name: string; size?: number; strokeWidth?: number; [key: string]: unknown } = $props();
</script>
